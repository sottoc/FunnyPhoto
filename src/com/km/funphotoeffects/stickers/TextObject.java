...
// Referenced classes of package com.km.funphotoeffects.stickers:
//            FontManager
...
public class TextObject
{
            ...
            float f7, float f8)
    {
        ...
        getPaint().setTypeface(FontManager.getTypeFace(context, mFont));
        return true;
    }
    ...
    public void draw(Canvas canvas)
    {
        ...
        paint1.setTextSize(f3 * f2);
        Log.e("gaurav", (new StringBuilder("size = ")).append(fontSize).toString());
        getPaint().setTypeface(FontManager.getTypeFace(context, mFont));
        new Rect((int)minX, (int)minY, (int)maxX, (int)maxY);
        maxX = minX + getPaint().measureText(text);
    ...
    public void load(Resources resources, float f, float f1, RectF rectf)
    {
        getMetrics(resources);
        ...
        setPos(f, f1, 0.0F, 0.0F, 0.0F, f2, f3, f4, f5);
    }
    ...
    public boolean setPos(ImageObject.PositionAndScale positionandscale)
    {
