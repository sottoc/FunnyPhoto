...
public class CustomTouch
{
    public static interface CommonListener
    {
        ...
        public abstract void getPositionAndScale(Object obj, ImageObject.PositionAndScale positionandscale);

        public abstract void onLongClick(Object obj, PointInfo pointinfo);

        public abstract void selectObject(Object obj, PointInfo pointinfo);

        public abstract boolean setPositionAndScale(Object obj, ImageObject.PositionAndScale positionandscale, PointInfo pointinfo);
    }
    ...
    private ImageObject.PositionAndScale mCurrXform;
    private int mMode;
    ...
    {
        selectedObject = null;
        mCurrXform = new ImageObject.PositionAndScale();
        mMode = 0;
        listener = new android.view.GestureDetector.SimpleOnGestureListener() {
            public boolean onDoubleTap(MotionEvent motionevent)
            {
                ...
                objectCanvas.onLongClick(selectedObject, mCurrPt);
                return true;
            }
    ...
    private void multiTouchController(MotionEvent motionevent)
    {
        switch(mMode){
        default:
        	break;
    ...
    public boolean onTouchEvent(MotionEvent motionevent)
    {
        ...
        try{
	        ...
	        while(true){
		        ...
		        multiTouchController(motionevent);
		        l++;
		        if(l > k)
		        {
		            return true;
