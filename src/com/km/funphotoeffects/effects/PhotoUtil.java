        ...
        throws OutOfMemoryError
    {
        ...
        while(k < j)
        {
            ...
            while(l < i)
            {
                ...
                int j2 = (int)(0.39300000000000002D * (double)k1 + 0.76900000000000002D * (double)l1 + 0.189D * (double)i2);
                int k2 = (int)(0.34899999999999998D * (double)k1 + 0.68600000000000005D * (double)l1 + 0.16800000000000001D * (double)i2);
                int l2 = (int)(0.27200000000000002D * (double)k1 + 0.53400000000000003D * (double)l1 + 0.13100000000000001D * (double)i2);
                int i3;
                int j3;
                int k3;
                int l3;
